...
@router.get("/api/v1/engines/latency-estimate")
...
@router.get("/api/v1/analytics/gap-analysis")
...
@router.get("/api/v1/analytics/gap-analysis/{course_id}")
...
@router.get("/api/v1/analytics/gap-analysis/top-deficits")
...
@router.get("/api/v1/analytics/district-summary")
...
@router.get("/api/v1/analytics/industry-demand")
...
@router.get("/api/v1/analytics/skill-gap-summary")
...
@router.get("/api/v1/districts/{district_name}/proposal")
...
@router.api_route("/api/v1/analytics/intervention-simulator", methods=["GET", "POST"])
...
@router.get("/api/v1/recommendations/all")
...
@router.get("/api/v1/crawler/status")
def get_crawl_status():
    """Get current async crawler progress."""
    return get_crawler_status()

@router.get("/api/v1/student/recommendations")
...
@router.get("/api/v1/student/districts")
...
@router.get("/api/v1/student/sectors")
